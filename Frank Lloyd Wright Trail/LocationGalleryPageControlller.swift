...
class LocationGalleryPageControlller: UIPageViewController, UIPageViewControllerDataSource {
    ...
    var site1:[UIImage] = [UIImage(named: "scjohnson")!, UIImage(named: "scjohnson2")!]
    var site2:[UIImage] = [UIImage(named: "wingspread")!, UIImage(named: "wingspread2")!]
    var site3:[UIImage] = [UIImage(named: "mononaterrace")!, UIImage(named: "mononaterrace2")!]
    var site4:[UIImage] = [UIImage(named: "meetinghouse")!, UIImage(named: "meetinghouse2")!]
    var site5:[UIImage] = [UIImage(named: "visitorcenter")!, UIImage(named: "visitorcenter2")!]
    var site6:[UIImage] = [UIImage(named: "warehouse")!, UIImage(named: "warehouse2")!]
    override func viewDidAppear(animated: Bool) {
        for i in 0...2 {
            ...
            case 42.7152375:
                controller.galleryImage.image = site1[i]
                imageControllers.append(controller)
            case 42.784472:
            controller.galleryImage.image = site2[i]
                imageControllers.append(controller)
            case 43.0717445:
            controller.galleryImage.image = site3[i]
                imageControllers.append(controller)
            case 43.0757361:
            controller.galleryImage.image = site4[i]
                imageControllers.append(controller)
            case 43.1439006:
            controller.galleryImage.image = site5[i]
                imageControllers.append(controller)
            case 43.3334718:
            controller.galleryImage.image = site6[i]
                imageControllers.append(controller)
            default:break
